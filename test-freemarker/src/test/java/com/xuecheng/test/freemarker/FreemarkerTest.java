...
public class FreemarkerTest {
    ...
    public void testGenerateBannerHtml() throws IOException, TemplateException {
        ...
        //输出流
        FileOutputStream outputStream =new FileOutputStream("d:/index_banner.html");
    ...
    public void testGenerateHtmlByHtml() throws IOException, TemplateException {
        ...
        stringTemplateLoader.putTemplate("test3",templateContent);
        ...
        //指定模板文件名称
        Template template = configuration.getTemplate("test3");
        ...
        InputStream inputStream = IOUtils.toInputStream(content);
        //输出流
        FileOutputStream outputStream =new FileOutputStream("d:/test3.html");
        IOUtils.copy(inputStream,outputStream);
