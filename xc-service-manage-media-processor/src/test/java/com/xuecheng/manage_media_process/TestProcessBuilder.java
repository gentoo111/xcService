...
public class TestProcessBuilder {
    ...
    public void testProcessBuilder() throws IOException {
        ...
        //将标准输入流和错误输入流合并,通过标准输入流读取信息就可以拿到第三方程序输出的错误信息和正常信息
    ...
    public void testProcessMp4(){
        ...
        //video_path视频地址
        String video_path = "/Users/szz/video/lucene.avi";
        //mp4_name mp4文件名称
        String mp4_name  ="lucene.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path="/Users/szz/video/";
