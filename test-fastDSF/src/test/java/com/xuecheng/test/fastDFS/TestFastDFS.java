...
public class TestFastDFS {
    ...
    public void testUpload() throws IOException, MyException {
         ...
         */
        //上传文件，成功后返回文件id（文件地址）
        String fileId = storageClient1.upload_file1("/Users/szz/IdeaProjects/xcEduService/d:/1.jpg", "png", null);
...
//        FileInfo fileInfo = storageClient1.query_file_info1(""); 查询
        FileOutputStream outputStream  =new FileOutputStream(new File("/Users/szz/IdeaProjects/xcEduService/d:/2.jpg"));
